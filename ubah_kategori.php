...
$query = query("SELECT * FROM kategori WHERE id_kategori = $id_kategori")[0];
$data = $query;
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light white bg-danger">
        <div class="container">
            <a class="navbar-brand text-white" href="#">Edit Kategori</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active text-white" aria-current="page" href="kategori.php">Lihat Data
                            Kategori</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-6">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" class="form-control" name="id_kategori" id="id_kategori"
                        value="<?= $data['id_kategori'] ?>" autocomplete="off">
