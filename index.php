...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
  ...
  <div class="app-wrapper">
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
              <img src="dist/assets/img/user4-128x128.jpg" class="user-image rounded-circle shadow" alt="User Image" />
              <span class="d-none d-md-inline"><?= $_SESSION['username'] ?></span>
            </a>
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
              <!--begin::User Image-->
              <li class="user-header text-bg-primary">
                <img src="dist/assets/img/user4-128x128.jpg" class="rounded-circle shadow" alt="User Image" />
                <p>
                  <?= $_SESSION['username'] ?>
                  <small>Halo <?= $_SESSION['username'] ?>, Membaca adalah investasi terbaik untuk masa depanmu.
    ...
    <footer class="app-footer">
      <!--begin::To the end-->
      <div class="float-end d-none d-sm-inline">Cuma perlu satu buku untuk jatuh cinta pada membaca. Cari buku itu. Mari
        jatuh cinta</div>
      <!--end::To the end-->
      <!--begin::Copyright-->
      <strong>
