...
if (isset($_POST['tombol_search'])) {
    ...
    $kategori = search_kategori($keyword);
}
?>
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img src="dist/assets/img/user4-128x128.jpg" class="user-image rounded-circle shadow"
                                alt="User Image" />
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <li class="user-header text-bg-primary">
                                <img src="dist/assets/img/user4-128x128.jpg" class="rounded-circle shadow"
                                    alt="User Image" />
                                <p>
                                    <?= $_SESSION['username'] ?>
                                    <small>Halo <?= $_SESSION['username'] ?>, Membaca adalah investasi terbaik untuk
                                        masa depanmu.
                                        Semangat selalu <?= $_SESSION['username'] ?> !!!</small>
                                </p>
                            </li>
                            <!--end::User Image-->
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                ...
                <a href="index.php" class="brand-link">
                    ...
                    <!--end::Brand Image-->
                    <!--begin::Brand Text-->
                    <span class="brand-text fw-light">Buku Online</span>
                    <!--end::Brand Text-->
                </a>
                <!--end::Brand Link-->
            </div>
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="kategori.php"
                                        class="nav-link <?= ($current_page == 'kategori.php') ? 'active' : '' ?>">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Data Kategori</p>
                                    </a>
                                </li>
        ...
        <footer class="app-footer">
            <!--begin::To the end-->
            <div class="float-end d-none d-sm-inline">Buku adalah jembatan menuju pengetahuan dan kebijaksanaan</div>
            <!--end::To the end-->
            <!--begin::Copyright-->
            <strong>
                Copyright &copy; bukuonline&nbsp;
            </strong>
            <!--end::Copyright-->
        </footer>
        <!--end::Footer-->
