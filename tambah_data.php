...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
  ...
  <div class="app-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <?php
              $qKategori = mysqli_query($conn, "SELECT id_kategori, nama_kategori FROM kategori ORDER BY id_kategori");
              $kategori = mysqli_fetch_all($qKategori, MYSQLI_ASSOC);
              ?>
    ...
    <footer class="app-footer">
      <!--begin::To the end-->
      <div class="float-end d-none d-sm-inline">Buku adalah gerbang dunia dan membaca adalah kuncinya</div>
      <!--end::To the end-->
      <!--begin::Copyright-->
      <strong>
